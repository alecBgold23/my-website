...
export default function Home() {
  return (
    <div>
      ...
      {/* Hero Section with Apple-style layout - Adjusted spacing */}
      <section className="bg-gradient-to-b from-white to-gray-50 relative overflow-hidden pt-16 pb-24">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center text-center mb-16">
            <h1 className="mb-2">
              <span className="bg-gradient-to-r from-[#0066ff] via-[#6a5acd] to-[#8c52ff] bg-clip-text text-transparent text-5xl md:text-6xl font-bold">
                BluBerry
              </span>
            </h1>
